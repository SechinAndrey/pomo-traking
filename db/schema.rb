...
ActiveRecord::Schema.define(version: 20170323115358) do
  ...
  create_table "statistics", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["project_id"], name: "index_statistics_on_project_id", using: :btree
  end
  ...
  add_foreign_key "statistics", "projects"
end
